...
public class SensitiveUserDataEntity {
    ...
    public SensitiveUserDataEntity(Long id, Long userId, String nik, String taxId,
    ...
    public static class Builder {
        ...
        public SensitiveUserDataEntity build() {
            return new SensitiveUserDataEntity(id, userId, nik, taxId, motherMaidenName,
