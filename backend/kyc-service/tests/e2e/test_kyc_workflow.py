...
class TestKycWorkflowE2E:
    ...
    async def test_complete_kyc_workflow_success(
        self, sample_user_id, sample_ktp_image, sample_selfie_image
    ):
        ...
        async with AsyncClient(
            ...
            with patch("app.services.kyc_service.OcrService") as MockOCR, patch(
                ...
                mock_ocr_instance.extract_ktp_data = AsyncMock(
    ...
    async def test_get_kyc_status_after_verification(
        self, sample_user_id, sample_verification_id
    ):
        ...
        async with AsyncClient(
            ...
            with patch(
                ...
                mock_entity.liveness_result = {"is_live": True, "confidence": 0.85}
                mock_entity.face_match_result = {
                    "is_match": True,
                    "similarity_score": 0.85,
                }
                mock_entity.dukcapil_result = {"is_valid": True, "name": "JOHN DOE"}
                ...
                assert data["liveness_result"]["is_live"] is True
                assert data["face_match_result"]["is_match"] is True
                assert data["dukcapil_result"]["is_valid"] is True
