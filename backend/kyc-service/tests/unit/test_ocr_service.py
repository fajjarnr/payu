...
class TestOcrService:
    ...
    @pytest.mark.asyncio
    async def test_extract_ktp_data_success(self, ocr_service, valid_ktp_image, mock_ocr_ktp_result):
    ...
    @pytest.mark.asyncio
    async def test_extract_ktp_data_empty_ocr_result(self, ocr_service, valid_ktp_image):
    ...
    def test_is_date_format_invalid_dates(self, ocr_service):
        ...
        assert ocr_service._is_date_format("1-1-1990") is False  # Single digit day/month
    ...
    def test_calculate_confidence_valid_result(self, ocr_service, mock_ocr_ktp_result):
        ...
        expected = sum([0.98, 0.97, 0.96, 0.95, 0.94, 0.93, 0.92, 0.91, 0.90, 0.89, 0.88, 0.87, 0.86, 0.85]) / 14
