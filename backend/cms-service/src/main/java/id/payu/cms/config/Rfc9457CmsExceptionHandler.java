...
public class Rfc9457CmsExceptionHandler extends Rfc9457GlobalExceptionHandler {
    ...
    public ResponseEntity<id.payu.api.common.exception.problem.ProblemDetail> handleAccessDenied(
        ...
        return respondWith(HttpStatus.FORBIDDEN, "Forbidden", "Insufficient permissions", "CMS_403", request);
    }
    ...
    public ResponseEntity<id.payu.api.common.exception.problem.ProblemDetail> handleMethodArgumentNotValid(
        ...
        return respondWith(HttpStatus.BAD_REQUEST, "Bad request", errors, "CMS_400", request);
    }
    ...
    public ResponseEntity<id.payu.api.common.exception.problem.ProblemDetail> handleConstraintViolation(
        ...
        return respondWith(HttpStatus.BAD_REQUEST, "Bad request", ex.getMessage(), "CMS_400", request);
    }
    ...
    public ResponseEntity<id.payu.api.common.exception.problem.ProblemDetail> handleIllegalStateException(
        ...
        return respondWith(HttpStatus.CONFLICT, "Conflict", ex.getMessage(), "CMS_409", request);
    }
