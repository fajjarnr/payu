...
public class SplitBillParticipant {
    ...
    // Default constructor
    public SplitBillParticipant() {
    }

    // All-args constructor
    public SplitBillParticipant(UUID id, UUID splitBillId, UUID accountId, String accountNumber,
    ...
    public static class SplitBillParticipantBuilder {
        ...
        public SplitBillParticipant build() {
            return new SplitBillParticipant(id, splitBillId, accountId, accountNumber, accountName,
