 ...
 * <ul>
 *   <li><b>PENDING</b> - DisbursementEntity created, awaiting processing</li>
...
public enum DisbursementStatus {
    /**
     * DisbursementEntity has been created but not yet processed.
     * Initial state after creation.
     */
    PENDING,

    /**
     * DisbursementEntity is being processed.
     * Funds have been debited from source account and BI-FAST transfer initiated.
     */
    PROCESSING,

    /**
     * DisbursementEntity completed successfully.
     * BI-FAST has confirmed the transfer to beneficiary account.
     */
    COMPLETED,

    /**
     * DisbursementEntity failed.
