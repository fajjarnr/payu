...
public class VirtualAccount {
    ...
    public static class VirtualAccountBuilder {
        ...
        public VirtualAccount build() {
            return new VirtualAccount(id, vaNumber, bankCode, bankName, partnerId, externalId, amount, currency, description, customerName, customerEmail, customerPhone, status, callbackUrl, paidAmount, paidAt, paymentReference, expiresAt, createdAt, updatedAt, idempotencyKey);
        }
    }
