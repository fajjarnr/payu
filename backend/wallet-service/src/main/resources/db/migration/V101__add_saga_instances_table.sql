-- Saga instances table for PayU Saga Starter (Wallet Service)
...
COMMENT ON TABLE saga_instances IS 'Persists distributed saga state for the Wallet orchestrators';
