...
CREATE INDEX IF NOT EXISTS idx_partner_tenant_id ON partners(tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_webhook_sub_tenant_id ON webhook_subscriptions(tenant_id);
