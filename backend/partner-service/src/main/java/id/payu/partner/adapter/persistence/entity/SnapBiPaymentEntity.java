...
public class SnapBiPaymentEntity {
    ...
    public SnapBiPaymentEntity() {
    }

    public SnapBiPaymentEntity(String payuReferenceNo, String partnerId, String partnerReferenceNo,
