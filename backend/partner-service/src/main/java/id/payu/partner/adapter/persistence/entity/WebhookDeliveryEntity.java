...
public class WebhookDeliveryEntity {
    ...
    public WebhookDeliveryEntity(WebhookSubscriptionEntity subscription, String eventId,
    ...
    public WebhookSubscriptionEntity getSubscription() { return subscription; }
    public void setSubscription(WebhookSubscriptionEntity subscription) { this.subscription = subscription; }
