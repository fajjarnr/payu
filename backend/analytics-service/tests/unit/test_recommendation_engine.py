...
def sample_spending_trends():
    ...
    return SpendingTrendResponse(
        ...
        top_merchants=[
            ...
            {"merchant_id": "merchant_2", "total_amount": 1000000.0, "transaction_count": 15}
        ]
    )
...
class TestRecommendationEngine:
    ...
    def test_generate_recommendations_high_spending(self, recommendation_engine, high_spending_user_metrics, sample_spending_trends):
        """Test recommendations for high spending user."""
        recommendations = recommendation_engine.generate_recommendations(
            high_spending_user_metrics,
            sample_spending_trends
        )
    ...
    def test_generate_recommendations_inactive_user(self, recommendation_engine, inactive_user_metrics, sample_spending_trends):
        """Test recommendations for inactive user."""
        recommendations = recommendation_engine.generate_recommendations(
            inactive_user_metrics,
            sample_spending_trends
        )
    ...
    def test_generate_recommendations_savings_goal(self, recommendation_engine, sample_user_metrics, savings_goal_trends):
    ...
    def test_generate_recommendations_with_mom_increase(self, recommendation_engine, sample_user_metrics):
    ...
    def test_generate_recommendations_with_mom_decrease(self, recommendation_engine, sample_user_metrics):
    ...
    def test_recommendation_priority_ordering(self, recommendation_engine, sample_user_metrics, sample_spending_trends):
    ...
    def test_recommendation_no_more_than_five(self, recommendation_engine, sample_user_metrics, sample_spending_trends):
    ...
    def test_generate_recommendations_empty_trends(self, recommendation_engine, sample_user_metrics):
    ...
    def test_recommendation_description_not_empty(self, recommendation_engine, sample_user_metrics, sample_spending_trends):
    ...
    def test_recommendation_for_entertainment_spending(self, recommendation_engine):
        ...
        recommendations = recommendation_engine.generate_recommendations(
            metrics,
            entertainment_heavy_trends
        )

        assert isinstance(recommendations, list)

        # Should trigger category-specific alert
        rec_descriptions = " ".join([rec.get("description", "") for rec in recommendations])
    ...
    def test_recommendation_for_top_merchant_concentration(self, recommendation_engine):
        ...
        concentrated_trends = SpendingTrendResponse(
            ...
            top_merchants=[
                {"merchant_id": "single_merchant", "total_amount": 7000000.0, "transaction_count": 70}
            ]
        )
