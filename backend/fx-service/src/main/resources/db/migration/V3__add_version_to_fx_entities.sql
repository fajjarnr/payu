...
ALTER TABLE fx_rates                            ADD COLUMN IF NOT EXISTS version BIGINT NOT NULL DEFAULT 0;
ALTER TABLE fx_conversions                      ADD COLUMN IF NOT EXISTS version BIGINT NOT NULL DEFAULT 0;
