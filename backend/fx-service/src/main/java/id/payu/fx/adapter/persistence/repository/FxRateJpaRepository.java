...
public interface FxRateJpaRepository extends JpaRepository<FxRateEntity, UUID> {
    ...
    Optional<FxRateEntity> findFirstByFromCurrencyAndToCurrencyAndValidFromLessThanEqualAndValidUntilGreaterThanEqualOrderByValidFromDesc(
            String fromCurrency, String toCurrency, LocalDateTime timestamp, LocalDateTime timestamp2);
