...
Comprehensive performance optimization guide for React and Next.js applications, covering Critical, High, Medium, and Low priority optimizations.

> **Full Rules Reference**: Read [.agent/skills/react-performance/references/performance-rules.md](.agent/skills/react-performance/references/performance-rules.md) for detailed code examples of all 40+ rules.
