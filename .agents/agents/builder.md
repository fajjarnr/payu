...
Actions:
1. Initialize artifact: bash .agents/skills/web-artifacts-builder/scripts/init-artifact.sh dashboard
2. Develop components in src/App.tsx
3. Bundle to single file: bash .agents/skills/web-artifacts-builder/scripts/bundle-artifact.sh
