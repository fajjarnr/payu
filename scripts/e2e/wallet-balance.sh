...
# Path segment is the ACCOUNT id (JWT sub), not the wallet UUID.
WALLET_ID="${WALLET_ID:-7753193d-b7e7-4e1e-bcb8-f9e4612e9207}"
# Account id matches dev seed wallet for customer1 (JWT sub).
