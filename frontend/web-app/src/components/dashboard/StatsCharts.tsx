...
export default function StatsCharts() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mt-6">
            ...
            <div className="md:col-span-5 bg-card p-8 rounded-[2.5rem] border border-border shadow-sm">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        ...
                        <h4 className="text-xl font-black text-foreground italic tracking-tighter">Rp 8.750.000</h4>
                    </div>
                </div>
            </div>

            {/* Spending Overview */}
            <div className="md:col-span-7 bg-card p-8 rounded-[2.5rem] border border-border shadow-sm">
                <div className="flex justify-between items-center mb-10">
                ...
                <div className="flex items-end justify-between h-32 gap-3 mt-4 px-4">
                    {[
                        { label: 'Jan', value: 30 },
                        { label: 'Feb', value: 45 },
                        { label: 'Mar', value: 60 },
                        ...
                        <div key={i} className="flex-1 flex flex-col items-center gap-4">
                            <div className="w-full relative group">
                                ...
                                />
                                {bar.active && (
                                    <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-foreground text-background text-[8px] font-black px-2 py-1 rounded-lg whitespace-nowrap z-10 shadow-xl">
                                        Rp 3.500.000
                                    </div>
                                )}
                            </div>
                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-tighter">{bar.label}</span>
                        </div>
                    ))}
                </div>
            </div>
