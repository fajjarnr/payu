                ...
                <div className="aspect-[1.6/1] bg-gradient-to-br from-bank-green to-bank-emerald rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-bank-green/20 group">
                    ...
                    <div className="relative h-full flex flex-col justify-between">
                        <div className="flex justify-between items-start">
                            <div className="flex items-center gap-2">
                                <div className="h-10 w-10 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center text-white font-black text-xl border border-white/20">
                                    U
                                </div>
                                <span className="text-2xl font-black tracking-tighter italic">PayU</span>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="text-xl md:text-2xl font-black tracking-[0.2em] font-mono">
                                2984 5678 9838 3723
                            </div>
                            <div className="flex justify-between items-end">
                                <div>
                                    <p className="text-[10px] text-white/60 font-black uppercase tracking-widest mb-1">Pemegang Kartu</p>
                                    <p className="text-sm font-black uppercase tracking-tight text-white">PENGGUNA PAYU</p>
                                </div>
                        ...
                        <div className="absolute top-0 right-0 text-[10px] font-black font-mono opacity-60">07/28</div>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="bg-card p-6 rounded-[2rem] border border-border shadow-sm flex flex-col justify-between flex-1">
            ...
            <div className="space-y-1">
                <h4 className="text-2xl font-black tracking-tight text-foreground italic">
