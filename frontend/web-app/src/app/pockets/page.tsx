    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto space-y-8 sm:space-y-10 pb-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
          ...
          <button className="bg-bank-green text-white px-6 sm:px-8 py-3 sm:py-4 rounded-[1.25rem] sm:rounded-[1.5rem] font-black text-xs uppercase tracking-widest hover:bg-bank-emerald transition-all active:scale-95 shadow-xl shadow-bank-green/20 flex items-center gap-2">
                ...
                <div className="space-y-4 sm:space-y-6">
                  {[1, 2, 3, 4].map(i => (
                    <div key={i} className="flex gap-3 sm:gap-4 animate-pulse">
                      <div className="h-10 w-10 sm:h-12 sm:w-12 bg-gray-100 dark:bg-gray-800 rounded-2xl" />
                      <div className="flex-1 space-y-2">
                        <div className="h-3 sm:h-4 bg-gray-100 dark:bg-gray-800 rounded w-1/2" />
        ...
        <div className="bg-foreground text-background rounded-[1.75rem] sm:rounded-[2.5rem] p-8 sm:p-12 relative overflow-hidden group shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-10">
            ...
            <button className="whitespace-nowrap px-8 sm:px-10 py-4 sm:py-5 bg-bank-green text-white rounded-[1.5rem] sm:rounded-3xl font-black uppercase text-xs tracking-widest hover:bg-bank-emerald transition-all active:scale-95 shadow-2xl shadow-bank-green/20">
