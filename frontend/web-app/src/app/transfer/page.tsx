              ...
              <StaggerItem>
                <ButtonMotion>
                  <button
                    ...
                    className="w-full bg-bank-green text-white py-5 sm:py-6 rounded-[1.25rem] sm:rounded-[1.5rem] font-black text-xs uppercase tracking-[0.2em] shadow-2xl shadow-bank-green/20 disabled:bg-bank-green/50 disabled:active:scale-100"
                  >
              ...
              <StaggerItem className="lg:col-span-8 space-y-6 sm:space-y-8">
                ...
                <ButtonMotion>
                  <button
                    ...
                    className="w-full bg-foreground text-background py-5 sm:py-6 rounded-[1.25rem] sm:rounded-[1.5rem] font-black text-xs uppercase tracking-[0.2em] shadow-2xl flex items-center justify-center gap-3 group"
                  >
