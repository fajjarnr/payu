...
|:---|:---:|:---|:---|
| ACCOUNT-006 | P1 | Coverage account ~21% line/19% branch; integration test tidak required di CI. **PROGRESS 2026-08-13**: core domain 55.2%→95.6%; gate-facing coverage (excl generated `grpc`/dto/entity/config/domain) 24.7%→61.8% — + BudgetControllerTest (8), BeneficiaryControllerTest (6), AccountPersistenceAdapterTest (5) + jacoco check exclude generated `**/grpc/**`. CI workflow ada. Sisa: gate-facing ≥80% (butuh ~310 baris lagi — BeneficiaryPersistenceAdapter, BudgetRepositoryAdapter, health web, client adapter), jacoco `verify` merah sampai naik. Done: ≥80% overall, 100% core domain, required CI. | 🟠 Test gate insufficient |
