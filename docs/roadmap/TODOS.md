...
| QAMVP-014 | Security test: wallet **FIXED 2026-08-13** (`WalletSecurityTest` 401/403/RBAC) + billing (`PaymentSecurityTest` 401+ownership); sisa kyc/analytics/backoffice/cms/api-portal | 🟡 |
