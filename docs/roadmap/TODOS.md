...
| OPS-2026-08-01-05 | P2 | Chaos | Kraken/preprod gate runtime: cerberus butuh KUBECONFIG; krkn report path PermissionError (SELinux/MCS atau entrypoint user); image `latest` belum digest-pinned. SCC anyuid + runAsUser 0 sudah, masih gagal. | 🔒 Investigate |
