...
| 39 | **AUDIT-039** ✅ CLOSED | ~~P2~~ | Observability | **CLOSED 2026-07-02**: Integrated Maestro E2E test suite in `.github/workflows/mobile-e2e.yml` to automatically validate mobile flows (`login`, `transfer`, `biometric-auth`, `offline-mode`) on push/PR events. | `.github/workflows/mobile-e2e.yml` created. |
