...
| FX-001 | P2 | [fx] `POST /api/v1/fx/conversions` & `/estimate` return 500: `DataIntegrityViolationException - Detached entity with generated id ... has an unsaved transient instance` (JPA cascade/persistence bug, pre-existing, ditemukan E2E 2026-07-31 — bukan cache). | 🔄 Planned |
