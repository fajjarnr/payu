...
| **Last Updated** | 2026-08-19 — ARCH-GLOBAL-007 scaffold (SET LOCAL + RLS) |
...
| GW-ROUTING-003 / BE-BIO-001 | 🔴 | gateway/biometric | 5 endpoint `/api/v1/biometric/*` (`AuthService.ts`, `security/page.tsx`) tanpa backend controller & gateway route — 404 | `AuthService.ts:152-187`; `RouteRegistry.java:123-200` |
