...
| QAMVP-013 | Outbox atomicity: wallet + transaction **FIXED 2026-08-13** (commit+rollback, real PG); `TestcontainersConfig` wallet+transaction terpakai; sisa billing/partner | 🟡 |
