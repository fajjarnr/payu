...
| **Last Release** | `1.18.65` (2026-08-28) |
...
| **Backlog Aktif** | **0 OPEN** — Grill P1 **7/7 CLOSED** 1.18.60-1.18.62 ✅ + **P3 Extended 3/3 CLOSED 1.18.63-1.18.64** (GLOBAL-WEBHOOK 1.18.63 + GLOBAL-RECON + GLOBAL-BFF 1.18.64) ✅ + **Hotfix 1.18.65 Insecure crypto.randomUUID Fallback** ✅ |
| **Last Updated** | 2026-08-28 — **1.18.65 Onboarding Insecure Context Fallback** + GLOBAL-RECON + GLOBAL-BFF **1.18.64** + GLOBAL-WEBHOOK **1.18.63** + Grill P1 1.18.60-1.18.62 + ADR-0071 **1.18.59** + ADR-0069 **1.18.58** |
