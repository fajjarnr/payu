...
| Cache                    | 🟠 Data Grid RESP stable, monitoring      | Workloads use `payu-cache-resp.payu-dev.svc.cluster.local:11222` mapped to the Data Grid RESP connector; one RESP/Netty reset warning remains under INFRA-025. |
...
| Last Status Update       | 2026-07-08                               | v1.9.3 P2 stability audit documented: Entity Operator and AMQ STOMP warnings cleared from active backlog; cache RESP warning remains monitored. |
