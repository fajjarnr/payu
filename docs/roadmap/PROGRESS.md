...
| **API Management**        | 🟢 3scale Tier 1 active                  | APIcast routing, Keycloak OIDC introspection, rate limiting, and E2E cards-crud verified. DEPLOY-010 closed. |
...
| Last Status Update       | 2026-07-13                               | v1.9.5: 3scale Tier 1 integration complete. OIDC issuer global fix. Card save() upsert fix. Rate limiting on redis-3scale. Lessons L-116–L-118 documented. |
