...
## L-429: OPEN reload-bounce tertutup rantai fix — verifikasi dulu sebelum persist store (2026-09-10)
...
## L-453: RHACS scan fail-open berlapis — CA drift + username panjang + viewer (2026-09-11)
...
## L-464: Child BOM import kalah dari literal parent — pin eksplisit per-artifact (2026-09-11)
